...
const RecentTestResults = () => {
  ...
  const fetchResults = async () => {
    ...
    setError(null);
    try {
      const response = await Api.get('results/getall');
  ...
  const getStatusBadge = (status) => {
    ...
    if (statusLower === 'passed') colorClasses = 'bg-green-100 text-green-800 border-green-200';
    else if (statusLower === 'failed') colorClasses = 'bg-red-100 text-red-800 border-red-200';
      ...
      <div className="flex-1 p-4 md:p-6">
        ...
        {loading ? (
          ...
          <div className="border rounded-lg text-center py-8">
            <div className="text-gray-500 text-lg">No test results available</div>
            <button 
                  ...
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm">
                        {result.ExamId?.duration? `${result.ExamId?.duration} mins` : 'N/A'}
                      </div>
                    </div>
                  </div>
