...
const handleNextClick = () => {
  ...
  navigate(`/homelivemocktest/${id}/${user?._id}`, { state: { language: finalLanguage } });
};

  const handlePreviousClick = () => {
    navigate(`/homeliveinstruct/${id}/${user?._id}`);
  };
...
export default Livemockotherinstruct;
