...
const Ibps_Po = () => {
     const [activeSection, setActiveSection] = useState(""); // Tracks active section (Prelims/Mains)
      ...
      const prelimsQuestions = {
        "IBPS PO 2025 Prelims Mock Test 1": { questions: [], free: true },
        "IBPS PO 2025 Prelims Mock Test 2": { questions: [], free: true },
        "IBPS PO 2025 Prelims Mock Test 3": { questions: [], free: true },
        "IBPS PO 2025 Prelims Mock Test 4": { questions: [], free: false },
      };
    
      const mainsQuestions = {
        "IBPS PO Mains 2025 Mock Test 1": { questions: [], free: false },
        "IBPS PO Mains 2025 Mock Test 2": { questions: [], free: false },
        "IBPS PO Mains 2025 Mock Test 3": { questions: [], free: false },
      };
...
<div className="container mt-3">
  ...
  Prepare for <span className="text-green-500">IBPS PO 2025</span> with high-quality, exam-level mock tests designed to
  match the latest pattern and evolving difficulty level. This package includes <span className="text-green-500">Prelims</span>
  and <span className="text-green-500">Mains</span> mock tests, along with <span className="text-green-500">Previous Year Papers</span>, ensuring comprehensive
  practice. With the introduction of new question formats in <span className="text-green-500">IBPS PO Mains</span>, these
  tests focus on hard-level questions to help you tackle challenging problems with
  confidence. Each test is structured to enhance your speed, accuracy, and problem-
  solving skills, with detailed solutions and performance analysis to track your
  progress. Regular practice with these tests will help you build exam temperament
  and confidence. Take the next step in your preparation and give yourself the best
  chance to crack <span className="text-green-500">IBPS PO 2025</span>!
                           </h1>
                       </div>
                   </div>
