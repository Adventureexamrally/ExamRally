        ...
        if (clickedQuestionIndex < startingIndex + questions.length - 1) {
            ...
            if (currentSectionIndex < examData.section.length - 1) {
                ...
                const newStartingIndex = examData?.section
                    ...
                    .reduce(
                        (acc, section) =>
                            acc + (section.questions?.[selectedLanguage?.toLowerCase()]?.length || 0), // Sum of questions per section
                        0
                    ) || 0;
                            ...
                            <div className="d-flex  justify-between bg-gray-100 border-1 p-2 border-gray-300 font-extralight">
                                ...
                                <div className="flex justify-center items-center ">
                                    ...
                                    <h3>
                                        ...
                                        ]?.[clickedQuestionIndex - startingIndex]?.q_on_time || 0}s
                                    </h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <p>Re-Attempt   &nbsp;&nbsp;</p>
                                ...
                                return (
                                    <div key={index}>
                                        <span
                                            ...
                                            className={`fw-bold flex align-items-center justify-content-center cursor-pointer ${className} ${clickedQuestionIndex === startingIndex + index ? "border-2 border-blue-500 scale-110 shadow-lg" : "opacity-80"}`}
                                        >
