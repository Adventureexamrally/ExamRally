    ...
    <>
      {loading ? (
        ...
        <div className="container">
          ...
          <Helmet>
            <title>{seo[0]?.seoData?.title || `${catDetail?.title?.replace(/<[^>]+>/g,'') || 'Live Test'} – ExamRally`}</title>
            <meta name="description" content={seo[0]?.seoData?.description || "Practice with ExamRally live test series. Get section-wise and topic-wise mock tests for bank and government exams."} />
            <meta name="keywords" content={seo[0]?.seoData?.keywords || "live test, bank exam mock test, topic test, ExamRally"} />
            <link rel="canonical" href={seo[0]?.seoData?.canonical || `https://examrally.in/livetest/${link}`} />
            <meta property="og:type" content="website" />
            <meta property="og:site_name" content="ExamRally" />
            <meta property="og:url" content={seo[0]?.seoData?.canonical || `https://examrally.in/livetest/${link}`} />
            <meta property="og:title" content={seo[0]?.seoData?.ogTitle || seo[0]?.seoData?.title || "Live Test – ExamRally"} />
            <meta property="og:description" content={seo[0]?.seoData?.ogDescription || seo[0]?.seoData?.description || "Practice with ExamRally live test series."} />
            <meta property="og:image" content={seo[0]?.seoData?.ogImageUrl || "https://examrally.in/web-app-manifest-512x512.png"} />
            <meta name="twitter:card" content="summary_large_image" />
            <meta name="twitter:title" content={seo[0]?.seoData?.ogTitle || seo[0]?.seoData?.title || "Live Test"} />
            <meta name="twitter:description" content={seo[0]?.seoData?.ogDescription || seo[0]?.seoData?.description || "Practice with ExamRally live test series."} />
