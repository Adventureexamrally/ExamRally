...
const ComputerAwareness = () => {
  ...
  const mainsQuestions = {
    "Computer Awareness Practice Test 1": [
    ...
    "Computer Awareness Practice Test 2": [
    ...
    "Computer Awareness Practice Test 3": [
  ...
  return (
    ...
    <div className="row ">
      ...
      <div className="col-md-9 staticheader">
          ...
          <h1 className="text-green-500 font font-bold ">   <ComputerIcon fontSize="large" className="text-green-500" /> 
            Computer Awareness</h1>
            <br />
            Our Computer Awareness Test Package is designed to help you prepare effectively
for banking and insurance exams like <span className="text-green font-weight-bold">IBPS PO, Clerk, RRB PO &amp; Clerk, SBI PO &amp;
Clerk, and RBI Grade B.</span> It covers all important topics, including computer
fundamentals, hardware, software, networking, cybersecurity, digital banking, and IT
in financial services. The questions are based on the latest exam pattern, helping
you build a strong foundation and improve your speed and accuracy. With detailed
explanations and regular updates, this package ensures you stay ahead in your
preparation and confidently tackle the Computer Awareness section in your exams.
</p>
          ...
          >
            ...
            <ul className="space-y-2">
              {[
                ...
                'Timely Updates on Computer Changes',
              ].map((item, index) => (
            ...
            <div className="text-center">
              ...
              <p className="text-white font-bold">You Save Money: 90</p>
            </div>
          </div>
        </div>
  </div>
