  ...
  const fetchSubscription = async () => {
    try {
      ...
      const filtered = response.data.filter(
        (sub) =>
          sub.subscriptionType?.trim().toLowerCase() === "rally super pro"
      );
          ...
          <div className="row">
            {sub ? (
              <>
                ...
                <div className="text-center mb-3 mt-3">
                  ...
                  {enrolled && !expired ? (
                    ...
                    <p className="text-md text-orange-500 mt-2 font">
                      <i className="bi bi-exclamation-triangle-fill"></i> Expired
                      - Repurchase
                    </p>
                  ) : (
                ...
                {showModal && (
                  <PackageCoupon pkg={sub} setShowModal={setShowModal} />
                )}
              </>
            ) : (
