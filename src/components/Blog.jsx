            ...
            <div className='container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mt-10 mb-10'>
                {trendingblog && trendingblog.map((blog, index) => (
                    ...
                    <div
                        ...
                        <div className={`grid ${blog.photo ? "grid-cols-1 md:grid-cols-[150px,2fr] lg:grid-cols-[150px,2fr]" : "grid-cols-1"} gap-4 items-center`}>

                            <div>
                                {/* <h1 className='text-4xl text-gray-200  font-sans font-bold m-2'>0{index + 1}</h1> */}
                                {blog.photo && <img src={blog.photo} alt="no photo" className='w-full object-cover' />}
                            </div>
                            <div
                                key={blog.id}
                                className="ml-11"
                    ...
                    {blogData && blogData.map((blog, index) => (
                        ...
                        >
                            <div className={`grid ${blog.photo ? "grid-cols-1 md:grid-cols-[150px,2fr] lg:grid-cols-[150px,2fr]" : "grid-cols-1"} gap-4 items-center`}>
                                <div>
                                    {/* <h1 className='text-4xl text-gray-200  font-sans font-bold m-2'>0{index + 1}</h1> */}
                                    {blog.photo && <img src={blog.photo} alt="no photo" className='w-full object-cover max-h-48' />}
                                </div>
                                {/* <Link to={blog.link}> */}
                                <div>
                                    <h2
